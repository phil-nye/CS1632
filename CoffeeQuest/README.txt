...
Files in CoffeeQuest directory:
    ...
    2)  All source code is located in the directory called "src".
            CoffeeQest.java     -->     contains main(); game driver that
                                        runs the game

            Player.java         -->     creates game environment (rooms)
                                        and layout of the rooms on the floor;
                                        determines which room the player is in;
                                        contains help()

            Room.java           -->     generates the room object; keeps track
                                        of what is in a particular room

            Inventory.java      -->     keeps track of the inventory; contains
